...
for (i in 1:5){
  ...
  bag_cart_train_table <- table(bag_cart_train_pred, y_train)
  ...
  bag_cart_test_table <- table(bag_cart_test_pred, y_test)
  ...
  bag_cart_validation_table <- table(bag_cart_validation_pred, validation01$bean_name)
